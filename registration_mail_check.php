...
//クロスサイトリクエストフォージェリ（CSRF）対策のトークン判定 ※POST= [name]で送ったトークンと生成したトークンの判定
...
if (count($errors) === 0){
	...
	$url = "http://so-world.sakura.ne.jp/login/registration_form.php"."?urltoken=".$urltoken;
